        ...
        <GridItem span={4}>
          <Card>
            <CardHeader>
              ...
              <CardActions>
                <Button component="a" href="https://pf-next.com/" target="_blank" variant="primary">Launch Jupyter</Button>
              </CardActions>
            </CardHeader>
            <CardHeader>
        ...
        <GridItem span={4}>
          <Card>
            <CardHeader>
              ...
              <CardActions>
                <Button component="a" href="https://pf-next.com/" target="_blank" variant="primary">Launch Argo</Button>
              </CardActions>
            </CardHeader>
            <CardHeader>
        ...
        <GridItem span={4}>
          <Card>
            <CardHeader>
              ...
              <CardActions>
                <Button component="a" href="https://pf-next.com/" target="_blank" variant="primary">Launch Superset</Button>
              </CardActions>
            </CardHeader>
            <CardHeader>
